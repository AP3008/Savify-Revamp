...
export default function Features() {
  ...
  return (
    <section id="why-savify" className="relative py-24 px-6 md:px-12 lg:px-24 bg-gradient-to-b from-brand-navy via-brand-charcoal to-brand-blue overflow-hidden">
